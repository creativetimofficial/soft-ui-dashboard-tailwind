...
!(function (t, e) {
    ...
    if (!(isNaN(d) || d <= 0)) {
      switch ((t.beginPath(), c)) {
        ...
        case "triangle":
          ...
          break;
        case "rectRounded":
          (l = 0.516 * d), (r = d - l), (s = Math.cos(u + wt) * r), (a = Math.sin(u + wt) * r), t.arc(i - s, n - a, l, u - xt, u - Mt), t.arc(i + a, n - s, l, u - Mt, u), t.arc(i + s, n + a, l, u, u + Mt), t.arc(i - a, n + s, l, u + Mt, u + xt), t.closePath();
          break;
        case "rect":
          if (!h) {
  ...
  class ji extends Oi {
    ...
    calculateLabelRotation() {
      ...
      (a = e.offset ? t.maxWidth / n : f / (n - 1)), d + 6 > a && ((a = f / (n - (e.offset ? 0.5 : 1))), (r = t.maxHeight - Wi(e.grid) - i.padding - Hi(e.title, t.chart.options.font)), (l = Math.sqrt(d * d + u * u)), (c = Et(Math.min(Math.asin(Math.min((h.highest.height + 6) / a, 1)), Math.asin(Math.min(r / l, 1)) - Math.asin(u / l)))), (c = Math.max(o, Math.min(s, c)))), (t.labelRotation = c);
    }
  ...
  (eo.id = "bar"), (eo.defaults = { datasetElementType: !1, dataElementType: "bar", categoryPercentage: 0.8, barPercentage: 0.9, grouped: !0, animations: { numbers: { type: "number", properties: ["x", "y", "base", "width", "height"] } } }), (eo.overrides = { interaction: { mode: "index" }, scales: { _index_: { type: "category", offset: !0, grid: { offset: !0 } }, _value_: { type: "linear", beginAtZero: !0 } } });
  class io extends Ai {
    initialize() {
  ...
  (no.id = "doughnut"),
    (no.defaults = { datasetElementType: !1, dataElementType: "arc", animation: { animateRotate: !0, animateScale: !1 }, animations: { numbers: { type: "number", properties: ["circumference", "endAngle", "innerRadius", "outerRadius", "startAngle", "x", "y", "offset", "borderWidth"] } }, cutout: "50%", rotation: 0, circumference: 360, radius: "100%", indexAxis: "r" }),
    (no.overrides = {
      aspectRatio: 1,
      plugins: {
        legend: {
  ...
  (so.id = "polarArea"),
    (so.defaults = { dataElementType: "arc", animation: { animateRotate: !0, animateScale: !0 }, animations: { numbers: { type: "number", properties: ["x", "y", "startAngle", "endAngle", "innerRadius", "outerRadius"] } }, indexAxis: "r", startAngle: 0 }),
    (so.overrides = {
      aspectRatio: 1,
      plugins: {
        legend: {
  ...
  class is extends Oi {
    ...
    _drawArgs(t) {
      ...
      let l,
        ...
        h,
        d = 0;
      return this.isHorizontal() ? ((c = o(r, i, s)), (h = e + t), (l = s - i)) : ("left" === a.position ? ((c = i + t), (h = o(r, n, e)), (d = -0.5 * xt)) : ((c = s - t), (h = o(r, e, n)), (d = 0.5 * xt)), (l = n - e)), { titleX: c, titleY: h, maxWidth: l, rotation: d };
    }
    draw() {
      const t = this,
        e = t.ctx,
